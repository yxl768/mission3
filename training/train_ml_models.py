...
from descriptors.descriptor_calculator import compute_descriptors_for_sequence, DESCRIPTOR_NAMES
...
def train_hemolysis_models():
    ...
    # 与规则公式对比
    from descriptors.descriptor_calculator import predict_hemolysis_risk as rule_predict
    rule_preds = []
